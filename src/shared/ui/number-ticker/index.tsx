...
import { Component, JSX, mergeProps, onMount, splitProps } from "solid-js";
...
export const NumberTicker: Component<NumberTickerProps> = (props) => {
  ...
  const [_localProps, forwardProps] = splitProps(props, ["value", "direction", "delay", "decimalPlaces"]);
  const localProps = mergeProps({ value: 100, direction: "up" as const, delay: 0, decimalPlaces: 0 }, _localProps);
    ...
    inView(ref, () => {
      animate(0, 1, {
        ...
        onUpdate: (progress) => {
          ...
          ref.textContent = Intl.NumberFormat(locale.locale(), {
